...
function __promptline_ps1 {
  ...
  # section "a" slices
  __promptline_wrapper "($(__promptline_conda_env)) $(__promptline_host)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
...
function __promptline {
  ...
  local a_fg="${wrap}38;2;238;232;213${end_wrap}"
  local a_bg="${wrap}48;2;101;123;131${end_wrap}"
  local a_sep_fg="${wrap}38;2;101;123;131${end_wrap}"
  local b_fg="${wrap}38;2;238;232;213${end_wrap}"
  local b_bg="${wrap}48;2;147;161;161${end_wrap}"
  local b_sep_fg="${wrap}38;2;147;161;161${end_wrap}"
  local c_fg="${wrap}38;2;147;161;161${end_wrap}"
  local c_bg="${wrap}48;2;238;232;213${end_wrap}"
  local c_sep_fg="${wrap}38;2;238;232;213${end_wrap}"
  local warn_fg="${wrap}38;2;253;246;227${end_wrap}"
  local warn_bg="${wrap}48;2;203;75;22${end_wrap}"
  local warn_sep_fg="${wrap}38;2;203;75;22${end_wrap}"
  local y_fg="${wrap}38;2;238;232;213${end_wrap}"
  local y_bg="${wrap}48;2;147;161;161${end_wrap}"
  local y_sep_fg="${wrap}38;2;147;161;161${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
